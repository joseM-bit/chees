/**
 * The Pawn class represents a pawn piece in a chess game and contains a move function that returns a
 * list of all possible destinations for the pawn.
 */
package pieces;
...
This is the pawn class that represents a pawn piece in a chess game.
@author [jose miguel]
 ...
 * @return A list of all the possible destinations of a pawn.
 */
