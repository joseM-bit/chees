/**
 * The King class represents a king piece in a chess game and includes methods for moving the king and
 * checking if it is under threat.
 */
package pieces;
...
This is the King class that represents a King piece in a chess game.
@author [jose miguel]
 ...
 * @return A list of all the possible destinations of a King.
 */
public class King extends Piece{
	...
	{
		setx(x);
		// `sety(y);` is a setter method for the private variable `y` in the `King` class. It sets the value
		// of `y` to the value passed as a parameter to the constructor.
		sety(y);
		setId(i);
		setPath(p);
		setColor(c);
